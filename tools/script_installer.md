...
[1/1] Compiling deno:std@$STD_VERSION/http/file_server.ts
...
```shell
deno install --allow-net --allow-read -n serve deno:std@$STD_VERSION/http/file_server.ts
```
...
```shell
deno install --allow-net --allow-read --root /usr/local deno:std@$STD_VERSION/http/file_server.ts
```
...
```shell
deno install --allow-net --allow-read deno:std@$STD_VERSION/http/file_server.ts -p 8080
```
